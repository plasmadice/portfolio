---
title: "Migrating leerob.io to Next.js 13 app Router Features"
...
In cloning and migrating Leerob.io's [blog](https://leerob.io/blog) to the [latest](https://nextjs.org/blog/next-13-4) Next.js 13 `app` router features, there were several fundamental shifts to highlight.

## Route Handler Conversion

**First**, the routing structure saw a transformation. Initially, routes were in the `/pages/api/views/[slug].ts` format. This was changed to the new `/app/api/views/[slug]/route.ts` format.
