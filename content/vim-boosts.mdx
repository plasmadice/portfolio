...
Eventually, moving the cursor with keystrokes is practically instant. As opposite to reaching for the mouse, finding it on the screen, and moving it to where you want to place it the cursor.
