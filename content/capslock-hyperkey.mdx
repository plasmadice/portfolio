...
- Hyper + S = <kbd>✱s</kbd> (Next tab in Chrome)
- Hyper + Command + S = <kbd>✱⌘s</kbd>(Previous Tab Chrome)

- Hyper + L = <kbd>✱l</kbd> (Arrow Right)
- Hyper + Command + L = <kbd>✱⌘l</kbd> (Move and select text to Right)
- Hyper + Option + L = <kbd>✱⌥l</kbd> (Move mouse cursor to Right)
