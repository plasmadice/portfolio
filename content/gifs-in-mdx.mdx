...
<Caption className="mx-auto" value="This is what I think about that">
  <GIF alt="GIF of Jennifer Lawrence saying 'Yeah, okay'" src="https://www.reactiongifs.com/r/jlaw-whtvr.gif"/>
</Caption>
...
<GIF size="xl" alt="GIF of guy saying 'Absolutely not'" src="https://media.giphy.com/media/H1YMguVrVeI0Xz5c8v/giphy.gif"/>
...
```tsx
<Image
  alt={`GIF of a skeleton`}
  src={`https://media.giphy.com/media/MynmWbOPGsv51V3VFW/giphy.gif`}
  width={200}
  height={200}
  className="mx-auto"
/>
