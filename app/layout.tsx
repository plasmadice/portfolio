...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body className="antialiased container px-8 justify-center mb-36 flex flex-col md:flex-row mt-8 md:mt-20 lg:mt-32 mx-auto overflow-x-hidden overflow-y-auto">
        <Sidebar />
